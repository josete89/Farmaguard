...
function initialize() {
	...
	var mapaNocturno = new google.maps.StyledMapType(stylesArray, {name: "Farmaguard"});
	...
	var myOptions = {
		...
		mapTypeControlOptions: {
	      mapTypeIds: [google.maps.MapTypeId.ROADMAP, 'Farmaguard']
	    }
	    
	};
	
	map = new google.maps.StyledMapType(document.getElementById("map_canvas"), myOptions);
